...
from db import create_user, authenticate_user, user_exists, get_user_sessions, create_session, end_session, log_emotion, get_last_session_timeline_data, get_emotion_distribution, get_emotion_transitions, get_session_emotion_breakdown, get_recent_system_events, get_user_profile, emotions_col, sessions_col
...
def login(user: UserLogin):
    ...
    access_token = create_access_token(
        data={"sub": authenticated["email"], "name": authenticated["name"]},
        expires_delta=access_token_expires
    )
    
    return {
        "message": "Login successful",
        "user": {"name": authenticated["name"], "email": authenticated["email"]},
        "token": access_token
    }
